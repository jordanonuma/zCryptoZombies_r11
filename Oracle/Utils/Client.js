const common = require('./utils/common.js') //example location when deployed via Truffle
const SLEEP_INTERVAL = process.env.SLEEP_INTERVAL || 2000 //example location when deployed via Truffle
const PRIVATE_KEY_FILE_NAME = process.env.PRIVATE_KEY_FILE || './caller/caller_private_key' //example location when deployed via Truffle
const CallerJSON = require('./caller/build/contracts/CallerContract.json') //example location when deployed via Truffle
const OracleJSON = require('./oracle/build/contracts/EthPriceOracle.json') //example location when deployed via Truffle
